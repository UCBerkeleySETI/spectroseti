...
apf_wavs = '/data/apf_wave.fits'
# Correpondence mask from raw to reduced
correspondence = 'apf_order_correspondence_fixed.npy'
# Logsheet Directory
logsheet_dir = '/media/nate/DATA/Spectra/apflogsheets/'
